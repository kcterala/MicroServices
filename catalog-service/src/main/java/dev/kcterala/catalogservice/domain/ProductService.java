...
import dev.kcterala.catalogservice.ApplicationProperties;
...
public class ProductService {
    ...
    public PagedResult<Product> getProducts(int pageNo) {
        ...
        Page<Product> productsPage = productRepository.findAll(pageable).map(Product::toProduct);
    ...
    public Optional<Product> getProductByCode(String code) {
        return productRepository.findByCode(code).map(Product::toProduct);
    }
}
